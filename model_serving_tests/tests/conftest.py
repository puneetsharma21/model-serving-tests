...
@pytest.fixture
def kserve_runtime_image():
    # dynamically build
    return "quay.io/opendatahub/vllm-runtime:latest"
...
def http_s3_vllm_raw_inference_service(
    ...
    ns_name = "vllm-auth-ns"
    namespace_obj = create_namespace(ns_name)

    return create_vllm_raw_inference_service(
        model_uri = "s3://odh-bucket/vllm-cpu-model/",
        namespace=ns_name,
        ...
        "serving.kserve.io/s3-endpoint": "s3.us-east.cloud-object-storage.appdomain.cloud",
